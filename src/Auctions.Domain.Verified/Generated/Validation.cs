// <auto-generated/>
// Compiled from Validation.dfy by 'dafny translate cs' — do not edit; run generate.sh instead.
// Dafny program Validation.dfy compiled into C#
...
// Command-line arguments: translate cs --include-runtime --output Generated/Validation Validation.dfy
// Validation.dfy
...
module AuctionValidation {
  ...
  function ValidateBid<U(==)>(bidder: U, seller: U, at: Int64, startsAt: Int64, expiry: Int64): (r: Errors)
    ...
    decreases at, startsAt, expiry
  {
    (if bidder == seller then ErrSellerCannotPlaceBids else ErrNone) | (if at < startsAt then ErrAuctionHasNotStarted else ErrNone) | if at > expiry then ErrAuctionHasEnded else ErrNone
  }

  function ValidateRaise(amount: Int64, highestBid: Int64, minRaise: Int64): (r: Errors)
    ensures var raise: int := if minRaise < 0 then 0 else minRaise as int; r == ErrNone <==> amount as int > highestBid as int && amount as int >= highestBid as int + raise
    ensures r == ErrNone || r == ErrMustPlaceBidOverHighestBid || r == ErrMustRaiseWithAtLeast
    decreases amount, highestBid, minRaise
  {
    var raise: Int64 := if minRaise < 0 then 0 else minRaise;
    if amount <= highestBid then
      ErrMustPlaceBidOverHighestBid
    else if highestBid > INT64_MAX - raise then
      ErrMustRaiseWithAtLeast
    else if amount < highestBid + raise then
      ErrMustRaiseWithAtLeast
    else
      ErrNone
  }
...
// end of class FuncExtensions
namespace AuctionValidation {

  public partial class __default {
    public static uint ValidateBid<__U>(__U bidder, __U seller, long at, long startsAt, long expiry)
    {
      return ((((object.Equals(bidder, seller)) ? (AuctionValidation.__default.ErrSellerCannotPlaceBids) : (AuctionValidation.__default.ErrNone))) | ((((at) < (startsAt)) ? (AuctionValidation.__default.ErrAuctionHasNotStarted) : (AuctionValidation.__default.ErrNone)))) | ((((at) > (expiry)) ? (AuctionValidation.__default.ErrAuctionHasEnded) : (AuctionValidation.__default.ErrNone)));
    }
    public static uint ValidateRaise(long amount, long highestBid, long minRaise)
    {
      long _0_raise = (((minRaise) < (0L)) ? (0L) : (minRaise));
      if ((amount) <= (highestBid)) {
        return AuctionValidation.__default.ErrMustPlaceBidOverHighestBid;
      } else if ((highestBid) > ((AuctionValidation.__default.INT64__MAX) - (_0_raise))) {
        return AuctionValidation.__default.ErrMustRaiseWithAtLeast;
      } else if ((amount) < ((highestBid) + (_0_raise))) {
        return AuctionValidation.__default.ErrMustRaiseWithAtLeast;
      } else {
        return AuctionValidation.__default.ErrNone;
      }
    }
    public static long INT64__MAX { get {
      return 9223372036854775807L;
    } }
    public static uint ErrNone { get {
      return 0U;
    } }
    public static uint ErrAuctionHasEnded { get {
      return 4U;
    } }
    public static uint ErrAuctionHasNotStarted { get {
      return 8U;
    } }
    public static uint ErrSellerCannotPlaceBids { get {
      return 32U;
    } }
    public static uint ErrMustPlaceBidOverHighestBid { get {
      return 256U;
    } }
    public static uint ErrMustRaiseWithAtLeast { get {
      return 1024U;
    } }
  }
...
} // end of namespace AuctionValidation
namespace _module {
